      ...
      >
        ...
        <motion.div className="space-y-8" variants={slideUp(0.2)}>
          ...
          <div className="text-center mt-8">
            <p className="font-semibold text-foreground mb-2">Follow us on social media:</p>
            <div className="flex justify-center space-x-4">
              <a href="#" className="bg-emerald-100 p-3 rounded-full text-emerald-600 hover:bg-emerald-200 transition-colors">
